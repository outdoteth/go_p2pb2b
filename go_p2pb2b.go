...
type depth_result struct {
	Asks [][2]string `json:"asks"`
	Bids [][2]string `json:"bids"`
}

type Depth_json struct {
	Success      bool         `json:"success"`
	Message      string       `json:"message"`
	Result       depth_result `json:"result"`
	Cache_time   float64      `json:"cache_time"`
	Current_time float64      `json:"current_time"`
}
...
func (clt *Client) Depth(opts Depth_params) (*Depth_json, error) {
